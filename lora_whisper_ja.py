...
small_common_voice["train"] = common_voice["train"].select(range(10000))
...
model_dir = r'C:\Users\Lily\Desktop\python\llama\speech-to-text\ja\20250415'
batch_size = 1
...
training_args = Seq2SeqTrainingArguments(
    ...
    #lr_scheduler_type='cosine', #修改不要COSINE!!!!
    #warmup_steps=700,
