# -*- coding: utf-8 -*-
"""speech-translation-ja.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IWoRZQO4qfEDbtFhyt-avr1CRqwVaYL1
"""
...
while True:
  with torch.cuda.amp.autocast():
    ...
    eval_prompt = 'translate japanese to chinese:\n input:' + speech_text + '\noutput:'
    inputs = mt_tokenizer(
            [
                alpaca_prompt.format(
                    "translate japanese to chinese:",  # instruction
                    speech_text,# input
