...
model_dir = r'C:\Users\Lily\Desktop\python\llama\speech-to-text\ja\20250415\checkpoint-10000'
...
common_voice["train"] = load_dataset('mozilla-foundation/common_voice_17_0','ja', split="test")
...
small_common_voice= common_voice["train"].select(range(1, 1000))
...
print(f"Base: the mean wer of japanese speech to text is {base_mean_wer}")
print(f"Fine tune: the mean wer of japanese speech to text is {peft_mean_wer}")