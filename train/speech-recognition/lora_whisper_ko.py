...
small_common_voice["train"] = common_voice["train"].shuffle(seed=411).select(range(10000))
small_common_voice["train"] = small_common_voice["train"].rename_column('text', 'sentence')
...
model_dir = r'C:\Users\Lily\Desktop\python\llama\speech-to-text\ko\20250330'
batch_size = 1
...
file_in_folder = os.listdir(model_dir)
